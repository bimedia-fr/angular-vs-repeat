        ...
        return {
            ...
            compile: function($element, $attrs){
                var ngRepeatChild = $element.children().eq(0),
                    ngRepeatAttr = ngRepeatChild.attr('ng-repeat') ? 'ng-repeat' : 'data-ng-repeat',
                    ngRepeatExpression = ngRepeatChild.attr(ngRepeatAttr),
                ...
                return {
                    pre: function($scope, $element, $attrs, $ctrl){
                                ...
                                $scope.$$postDigest(function(){
                                    if($element[0].offsetHeight || $element[0].offsetWidth){ // element is visible
                                        ...
                                        while(i < children.length){
                                            if(children[i].attributes[ngRepeatAttr] != null){
                        ...
                        childClone.attr(ngRepeatAttr, lhs + ' in ' + collectionName + (rhsSuffix ? ' ' + rhsSuffix : ''))
                        ...
                        function resizeFillElement(size){
                            if($$horizontal){
                                ...
                                if($ctrl && $ctrl.$fillElement){
                                    var referenceElement = $ctrl.$fillElement[0].parentNode.querySelector('[' + ngRepeatAttr + ']');
                                    if(referenceElement)
                                ...
                                if($ctrl && $ctrl.$fillElement){
                                    referenceElement = $ctrl.$fillElement[0].parentNode.querySelector('[' + ngRepeatAttr + ']');
                                    if(referenceElement)
                                        $ctrl.$fillElement.css({
